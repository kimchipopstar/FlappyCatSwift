...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMove(to view: SKView) {
        ...
        pipeTextureUp = SKTexture(imageNamed: "cigaretteUp")
        pipeTextureUp.filteringMode = .nearest
        pipeTextureDown = SKTexture(imageNamed: "cigaretteDown")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Kitty")
        birdTexture1.filteringMode = .nearest
        let birdTexture2 = SKTexture(imageNamed: "Kitty")
